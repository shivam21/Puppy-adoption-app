    ...
    val dogList: List<DogItem>
        get() = listOf(
            ...
            DogItem(
                ...
                "Buster loves affection, hikes and treats! He's playful and loves hiking in the canyons.His favorite dinner dish is sloppy joes. After dinner he's always excited to cuddle on the couch and watch The Voice. He is crate trained,he walks well on a leash now and wears a front clip harness to walk with. He is dog selective, if introduced correctly he can be good with another dog of his own size. He gets groomed every six weeks for anal gland expression and shedding. He is Incredibly loving, very smart and figured out how to get into our fridge. He loves to cuddle."
            ),
            DogItem(
                3,
                "Lucas",
            ...
            DogItem(
                ...
                "Sheep guarding",
                "Edison was found as a stray injured when he was attached by another dog. Edison does not get along well with other dogs, would do great as a single dog in a home. Very cautious when first meeting, but a love bug and very obedient. He knows sit and stays with you with no reaction towards other dogs except being cautious with males because of his experience. His foster says that he is just the best & will make a wonderful forever friend to some lucky adopter. Who knows, that could be you!"
            ),
            DogItem(
                6,
                "Riley",
                ...
                "Hunting bears",
                "Riley was found as a stray by her foster, she is aprox. 1 year old, very playful, and will be the perfect fit for an active family who is available to continue her puppy training."
            ),
            DogItem(
                7,
                "Precious",
                ...
                "Guarding",
                "Precious is a loving pup who just wants to be near her people. She likes sitting next to you on the couch watching tv or reading a book, she like finding a free corner to sit and watch you cook in the kitchen, and she likes sitting in the back seat to run errands. She's energetic and friendly and is searching for her perfect permanent family!"
            ),
            DogItem(
                8,
                "Tink",
                "Shepherd (Unknown Type)/Labrador Retriever Mix",
                "https://cdn2.thedogapi.com/images/dW5UucTIW.jpg",
                "Hauling heavy freight, Sled pulling",
                "Hello, my name is Tink! I was rescued from the shelter in honor of a dog who suffered a horrible fate there. I love people, but don't get along with most dogs. I am about 3 years old and looking for my forever family. If you think that is you please contact Ace of Hearts so we can meet!"
            ),
        )
}